...
#define P2V(paddr)          ((uint32_t)(paddr)  +  HIGHER_HLF_BASE)
#define V2P(vaddr)          ((uint32_t)(vaddr)  -  HIGHER_HLF_BASE)

#define PG_ALIGN(addr)      ((uint32_t)(addr)   & 0xFFFFF000UL)

#define PD_INDEX(vaddr)     (((uint32_t)(vaddr) & 0xFFC00000UL) >> 22)
#define PT_INDEX(vaddr)     (((uint32_t)(vaddr) & 0x003FF000UL) >> 12)
#define PG_OFFSET(vaddr)    ((uint32_t)(vaddr)  & 0x00000FFFUL)
